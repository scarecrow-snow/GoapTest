...
public class GoapAgent : MonoBehaviour
{
    ...
    void CalculatePlan()
    {
        ...
        HashSet<AgentGoal> golasToCheck = goals;

        if(currentGoal != null)
        {
            Debug.Log("Current goal exists, checking goals with higher priority");
            golasToCheck = new HashSet<AgentGoal>(goals.Where(g => g.Priority > priorityLevel));
        }

        var potentialPlan = gPlanner.Plan(this, golasToCheck, lastGoal);
